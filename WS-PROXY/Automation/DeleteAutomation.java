/**************************************************************************************************************
* @Name                         : DeleteAutomationBasedOnName
* @Author                       : Adarsh
...
try{
    ...
    var filter= ApplyFilter("Name","equals","Lead Data Sync");
   ...
   //Call the function  from the SOAP object   where the status equal 2
    ...
    var result=DeletetemSoapObject(soapObjectname,response);
...
//Function to delete operation on a SOAP object using WS Proxy
/**
 * Parameters:-
...
function DeletetemSoapObject(soapObjectname,payload){
var api= new Script.Util.WSProxy();
 api.setClientId({
